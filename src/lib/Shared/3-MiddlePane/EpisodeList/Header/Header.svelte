<script>
	...
	import Image from '$lib/functions/Image.svelte';
	...
	function getColors() {
		// console.log(podcastLogo);
		// console.log(getPalette(podcastLogo));
		// ['#000000', ...]
		// gradient = fitGradient(podcastLogo);
		// console.log(fitGradient(podcastLogo));
		...
		<div class="logo">
			{#if $selectedPodcast}
				<Image
					...
					on:error={handleImageErr}
					on:load={getColors}
					bind:this={podcastLogo}
